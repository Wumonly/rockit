...
const CURRENT_PLUGIN_SLUG = 'rockit';
const LEGACY_PLUGIN_SLUG = 'rockit';
...
/**
 * Resolve the RocKit source root directory.
 *
 * Tries, in order:
 ...
 *   4. Plugin cache auto-detection — scans ~/.claude/plugins/cache/rockit/
 ...
 *                                    contains RocKit scripts. Default: 'scripts/lib/utils.js'
 * @returns {string} Resolved RocKit root path
 */
